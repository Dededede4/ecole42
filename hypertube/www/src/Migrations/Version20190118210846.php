 ...
 */
final class Version20190118210846 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN facebook_id INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN intra42_id INTEGER DEFAULT NULL');
    }
